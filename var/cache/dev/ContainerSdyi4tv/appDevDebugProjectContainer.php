...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'api.account_service' => 'getApi_AccountServiceService.php',
            'api.action_service' => 'getApi_ActionServiceService.php',
            'api.block_service' => 'getApi_BlockServiceService.php',
            'api.transaction_service' => 'getApi_TransactionServiceService.php',
            'api.twitter_service' => 'getApi_TwitterServiceService.php',
            'api.vote_service' => 'getApi_VoteServiceService.php',
            ...
            'snc_redis.command.flush_all' => 'getSncRedis_Command_FlushAllService.php',
            'snc_redis.command.flush_db' => 'getSncRedis_Command_FlushDbService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Cache/Traits/RedisTrait.php';
            include_once $this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Cache/Adapter/RedisAdapter.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection($this->getEnv('REDIS_URL'), array('lazy' => true)), 'nlgt3aC7lD', 0);
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('61eDOrGxu1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Snc\RedisBundle\DataCollector\RedisDataCollector(${($_ = isset($this->services['snc_redis.logger']) ? $this->services['snc_redis.logger'] : $this->getSncRedis_LoggerService()) && false ?: '_'}));
        $instance->add($e);
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TW-8qnquPf', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8SVoy7IWU6', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tvOAw4RUDH', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    /**
     * Gets the private 'monolog.logger.snc_redis' shared service.
     *
     * @return \Symfony\Bridge\Monolog\Logger
     */
    ...
    {
        return $this->services['snc_redis.logger'] = new \Snc\RedisBundle\Logger\RedisLogger(${($_ = isset($this->services['monolog.logger.snc_redis']) ? $this->services['monolog.logger.snc_redis'] : $this->getMonolog_Logger_SncRedisService()) && false ?: '_'});
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'env(DB_URL)' => 'mysql://root:FQTAADA6F3FLsPPgKwPN@192.168.1.12/eos-test',
            'env(REDIS_URL)' => 'redis://root@127.0.0.1:6379',
            'locale' => 'en',
